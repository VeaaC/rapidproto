...
- `./check.sh deep` — the heavy tier: ASan + UBSan, a library coverage floor, and a fuzz smoke.
...
- All hand-written code is `clang-format`ed — the gate enforces it; nothing is exempt. Comments
