...
RP_FLATTEN inline const std::uint8_t* ::rp::arena::re::Holder::rp_decode_into([[maybe_unused]] ::rp::arena::re::Holder& out, const std::uint8_t* rp_c, const std::uint8_t* const rp_cend, const std::uint8_t* const rp_beg, const std::uint32_t rp_term, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
