...
static_assert(::std::is_trivially_destructible_v<Sub>);

// NOLINTNEXTLINE(readability-function-cognitive-complexity): generated field dispatch
RP_FLATTEN inline const std::uint8_t* ::rp::arena::pa::linux_::Sub::rp_decode_into([[maybe_unused]] ::rp::arena::pa::linux_::Sub& out, const std::uint8_t* rp_c, const std::uint8_t* const rp_cend, const std::uint8_t* const rp_beg, const std::uint32_t rp_term, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
...
inline const ::rp::arena::pa::linux_::Sub* ::rp::arena::pa::linux_::Sub::decode(::rapidproto::ByteView input, ::rapidproto::Arena& arena, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (input.size() > UINT32_MAX) { ::rapidproto::rp_fail_input_too_large(err); return nullptr; }
  ::rp::arena::pa::linux_::Sub* const rp_root = arena.create<::rp::arena::pa::linux_::Sub>();
