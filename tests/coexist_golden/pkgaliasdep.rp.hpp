...
RP_FLATTEN inline bool ::rp::arena::pa::linux_::Sub::rp_decode_into([[maybe_unused]] ::rp::arena::pa::linux_::Sub& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
