...
class Entry {
 ...
 private:
  ...
  static bool rp_decode_into(Entry& out, ::rapidproto::ByteView body, ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept;
  std::int32_t m_y;
};
...
RP_FLATTEN inline bool ::rp::arena::sib::stream::logging::v1::Entry::rp_decode_into([[maybe_unused]] ::rp::arena::sib::stream::logging::v1::Entry& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
