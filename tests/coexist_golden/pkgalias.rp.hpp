...
class linux__ {
 ...
 private:
  ...
  static bool rp_decode_into(linux__& out, ::rapidproto::ByteView body, ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept;
...
RP_FLATTEN inline bool ::rp::arena::pa::linux__::rp_decode_into([[maybe_unused]] ::rp::arena::pa::linux__& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
