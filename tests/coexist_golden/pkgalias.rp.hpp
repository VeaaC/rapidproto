...
#include "pkgaliasdep.rp.hpp"

namespace rp::arena::pa {
...
class linux__ {
 public:
  ...
  ::rp::common::pa::linux__::E e() const noexcept { return m_e; }
  const ::rp::arena::pa::linux_::Sub* sub() const noexcept { return (m_rp_mask & (std::uint8_t{1} << 0)) != 0 ? &m_sub : nullptr; }
  ::rp::common::pa::linux_::E f() const noexcept { return m_f; }
  [[nodiscard]] static const linux__* decode(::rapidproto::ByteView input, ::rapidproto::Arena& arena, ::rapidproto::ArenaDecodeError* err = nullptr) noexcept;
 private:
  ...
  static const std::uint8_t* rp_decode_into(linux__& out, const std::uint8_t* rp_c, const std::uint8_t* rp_cend, const std::uint8_t* rp_beg, std::uint32_t rp_term, ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept;
  ::rp::common::pa::linux__::E m_e;
  ::rp::arena::pa::linux_::Sub m_sub;
  ::rp::common::pa::linux_::E m_f;
  std::uint8_t m_rp_mask;
};
static_assert(::std::is_trivially_destructible_v<linux__>);

// NOLINTNEXTLINE(readability-function-cognitive-complexity): generated field dispatch
RP_FLATTEN inline const std::uint8_t* ::rp::arena::pa::linux__::rp_decode_into([[maybe_unused]] ::rp::arena::pa::linux__& out, const std::uint8_t* rp_c, const std::uint8_t* const rp_cend, const std::uint8_t* const rp_beg, const std::uint32_t rp_term, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    rp_do_1: {
      ...
      rp_c = rp_np;
      out.m_e = static_cast<::rp::common::pa::linux__::E>(::rapidproto::varint_to_int32(rp_raw));
    ...
    rp_do_3: {
      ...
      if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - rp_beg)); return nullptr; }
      rp_c = rp_np;
      out.m_f = static_cast<::rp::common::pa::linux_::E>(::rapidproto::varint_to_int32(rp_raw));
      continue;
    }
    rp_field_general:;
...
inline const ::rp::arena::pa::linux__* ::rp::arena::pa::linux__::decode(::rapidproto::ByteView input, ::rapidproto::Arena& arena, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (input.size() > UINT32_MAX) { ::rapidproto::rp_fail_input_too_large(err); return nullptr; }
  ::rp::arena::pa::linux__* const rp_root = arena.create<::rp::arena::pa::linux__>();
