...
inline void rp_debug_write(const ::mr::ManyRequired& m, ::rapidproto::debug::Writer& w);
...
inline void rp_debug_write(std::ostream& rp_os, const ::mr::ManyRequired& m, std::size_t rp_width = 120) {
  rp_os << std::boolalpha;
  ::rapidproto::debug::Writer w(rp_os, rp_width);
  rp_debug_write(m, w);
}

inline std::string rp_debug_string(const ::mr::ManyRequired& m, std::size_t rp_width = 120) {
