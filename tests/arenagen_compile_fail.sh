...
#include "proto3.rp.hpp"
void f(rapidproto::ByteView b, rapidproto::Arena& a) {
  const rp::arena::p3::Msg* m = rp::arena::p3::Msg::decode(b, a);
  m->pick([](rp::arena::p3::Msg::Pick::a, std::int32_t){}, [](std::monostate){}); }'
...
void f(rapidproto::ByteView b, rapidproto::Arena& a) {
  const rp::arena::p3::Msg* m = rp::arena::p3::Msg::decode(b, a);
  m->pick([](rp::arena::p3::Msg::Pick::a, float){}); }'
...
void f(rapidproto::ByteView b, rapidproto::Arena& a) {
  const rp::arena::p3::Msg* m = rp::arena::p3::Msg::decode(b, a);
  m->pick([](rp::arena::p3::Msg::Pick::a, std::int32_t){}, [](rp::arena::p3::Msg::Pick::a, std::int32_t){}); }'
...
void f(rapidproto::ByteView b, rapidproto::Arena& a) {
  const rp::arena::p3::Msg* m = rp::arena::p3::Msg::decode(b, a);
  m->pick([](rp::arena::p3::Msg::Pick::a, auto){}); }'
...
void f(rapidproto::ByteView b, rapidproto::Arena& a) {
  const rp::arena::p3::Msg* m = rp::arena::p3::Msg::decode(b, a);
  m->pick([](rp::arena::p2::Container::Choice::ci, std::int32_t){}); }'
...
#include "proto3.rp.hpp"
void f() { rp::arena::p3::Msg::rp_pick_union u; (void)u; }'
...
void f(rapidproto::ByteView b, rapidproto::Arena& a) {
  const rp::arena::p3::Msg* m = rp::arena::p3::Msg::decode(b, a);
  m->pick([](rp::arena::p3::Msg::Pick::a, std::int32_t) { return rapidproto::DecodeStatus::success(); }); }'
...
void f(rapidproto::ByteView b, rapidproto::Arena& a) {
  const rp::arena::fm::Holder* h = rp::arena::fm::Holder::decode(b, a);
  (void)h->debug(); }'
...
void f(rapidproto::ByteView b, rapidproto::Arena& a) {
  const rp::arena::fm::Holder* h = rp::arena::fm::Holder::decode(b, a);
  if (h->blob()) { (void)rp::arena::fm::Blob::decode(*h->blob(), a); }
  for (rapidproto::ByteView v : h->blobs()) { (void)rp::arena::fm::Blob::decode(v, a); } }'
