...
class Main {
 public:
  ...
  std::optional<::rp::common::dep::DepEnum> e() const noexcept { return (m_rp_mask & (std::uint8_t{1} << 3)) != 0 ? std::optional<::rp::common::dep::DepEnum>(m_e) : std::nullopt; }
...
RP_FLATTEN RP_NOINLINE inline const std::uint8_t* ::rp::arena::main::Main::rp_decode_into([[maybe_unused]] ::rp::arena::main::Main& out, const std::uint8_t* rp_c, const std::uint8_t* const rp_cend, const std::uint8_t* const rp_beg, const std::uint32_t rp_term, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    rp_do_4: {
      ...
      rp_c = rp_np;
      out.m_e = static_cast<::rp::common::dep::DepEnum>(::rapidproto::varint_to_int32(rp_raw));
