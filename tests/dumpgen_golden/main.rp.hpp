...
class Main {
 public:
  ...
  ::rapidproto::ArrayView<::dep::Dep> ds() const noexcept { return m_ds.view(); }
 ...
 private:
  ...
  ::fwd::Fwd m_f;
  ::dep::DepEnum m_e;
  ::rapidproto::ArenaArray<::dep::Dep> m_ds;
...
RP_FLATTEN inline bool Main::rp_decode_into([[maybe_unused]] Main& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  ::rapidproto::ArenaArray<::dep::Dep>::store(&out.m_ds, rp_acc_ds, rp_n_ds);
