...
inline void rp_dump_write(std::ostream& rp_os, const ::main::Main& m, std::size_t rp_width = 120) {
  rp_os << std::boolalpha;
  ::rapidproto::dump::Writer w(rp_os, rp_width);
  rp_dump_write(m, w);
}

inline std::string rp_dump_string(const ::main::Main& m, std::size_t rp_width = 120) {
