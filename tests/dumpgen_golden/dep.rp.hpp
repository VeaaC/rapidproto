...
class Dep {
 public:
  ...
  std::optional<::rp::enums::dep::DepEnum> de() const noexcept { return (m_rp_mask & (std::uint8_t{1} << 1)) != 0 ? std::optional<::rp::enums::dep::DepEnum>(m_de) : std::nullopt; }
...
RP_FLATTEN inline bool ::rp::arena::dep::Dep::rp_decode_into([[maybe_unused]] ::rp::arena::dep::Dep& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    rp_do_2: {
      ...
      if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - ::rapidproto::wire::byte_ptr(body))); return false; }
      rp_c = rp_np;
      out.m_de = static_cast<::rp::enums::dep::DepEnum>(::rapidproto::varint_to_int32(rp_raw));
