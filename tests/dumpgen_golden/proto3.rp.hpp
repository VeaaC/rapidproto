...
class Msg {
 public:
  ...
  ::rp::enums::p3::State state() const noexcept { return m_state; }
  ...
  ::rapidproto::ArrayView<::rp::enums::p3::State> states() const noexcept { return m_states; }
  ...
  template <class... rp_Fs> void pick(rp_Fs&&... rp_fs) const {
    static_assert((0U + ... + static_cast<unsigned>(::rapidproto::specifically_handles<rp_Fs, Pick::a, typename Pick::a::Value>)) <= 1U, "oneof member '::rp::arena::p3::Msg::a' is handled by more than one callback");
    static_assert((0U + ... + static_cast<unsigned>(::rapidproto::is_catch_all<rp_Fs, Pick::a, typename Pick::a::Value>)) <= 1U, "oneof member '::rp::arena::p3::Msg::a' is matched by more than one catch-all callback");
    static_assert((true && ... && !::rapidproto::is_partial_generic<rp_Fs, Pick::a, typename Pick::a::Value>), "a callback for oneof member '::rp::arena::p3::Msg::a' is partially generic; use a concrete (Tag, Value) callback or a fully generic (auto, auto) catch-all");
    static_assert((true && ... && !(::rapidproto::targets<rp_Fs, Pick::a, typename Pick::a::Value> && !::rapidproto::specifically_handles<rp_Fs, Pick::a, typename Pick::a::Value>)), "a callback for oneof member '::rp::arena::p3::Msg::a' has the wrong value type (expected Pick::a::Value)");
    static_assert((0U + ... + static_cast<unsigned>(::rapidproto::specifically_handles<rp_Fs, Pick::b, typename Pick::b::Value>)) <= 1U, "oneof member '::rp::arena::p3::Msg::b' is handled by more than one callback");
    static_assert((0U + ... + static_cast<unsigned>(::rapidproto::is_catch_all<rp_Fs, Pick::b, typename Pick::b::Value>)) <= 1U, "oneof member '::rp::arena::p3::Msg::b' is matched by more than one catch-all callback");
    static_assert((true && ... && !::rapidproto::is_partial_generic<rp_Fs, Pick::b, typename Pick::b::Value>), "a callback for oneof member '::rp::arena::p3::Msg::b' is partially generic; use a concrete (Tag, Value) callback or a fully generic (auto, auto) catch-all");
    static_assert((true && ... && !(::rapidproto::targets<rp_Fs, Pick::b, typename Pick::b::Value> && !::rapidproto::specifically_handles<rp_Fs, Pick::b, typename Pick::b::Value>)), "a callback for oneof member '::rp::arena::p3::Msg::b' has the wrong value type (expected Pick::b::Value)");
    static_assert((0U + ... + static_cast<unsigned>(::rapidproto::specifically_handles<rp_Fs, Pick::c, typename Pick::c::Value>)) <= 1U, "oneof member '::rp::arena::p3::Msg::c' is handled by more than one callback");
    static_assert((0U + ... + static_cast<unsigned>(::rapidproto::is_catch_all<rp_Fs, Pick::c, typename Pick::c::Value>)) <= 1U, "oneof member '::rp::arena::p3::Msg::c' is matched by more than one catch-all callback");
    static_assert((true && ... && !::rapidproto::is_partial_generic<rp_Fs, Pick::c, typename Pick::c::Value>), "a callback for oneof member '::rp::arena::p3::Msg::c' is partially generic; use a concrete (Tag, Value) callback or a fully generic (auto, auto) catch-all");
    static_assert((true && ... && !(::rapidproto::targets<rp_Fs, Pick::c, typename Pick::c::Value> && !::rapidproto::specifically_handles<rp_Fs, Pick::c, typename Pick::c::Value>)), "a callback for oneof member '::rp::arena::p3::Msg::c' has the wrong value type (expected Pick::c::Value)");
    static_assert((0U + ... + static_cast<unsigned>(::rapidproto::specifically_handles<rp_Fs, Pick::d, typename Pick::d::Value>)) <= 1U, "oneof member '::rp::arena::p3::Msg::d' is handled by more than one callback");
    static_assert((0U + ... + static_cast<unsigned>(::rapidproto::is_catch_all<rp_Fs, Pick::d, typename Pick::d::Value>)) <= 1U, "oneof member '::rp::arena::p3::Msg::d' is matched by more than one catch-all callback");
    static_assert((true && ... && !::rapidproto::is_partial_generic<rp_Fs, Pick::d, typename Pick::d::Value>), "a callback for oneof member '::rp::arena::p3::Msg::d' is partially generic; use a concrete (Tag, Value) callback or a fully generic (auto, auto) catch-all");
    static_assert((true && ... && !(::rapidproto::targets<rp_Fs, Pick::d, typename Pick::d::Value> && !::rapidproto::specifically_handles<rp_Fs, Pick::d, typename Pick::d::Value>)), "a callback for oneof member '::rp::arena::p3::Msg::d' has the wrong value type (expected Pick::d::Value)");
 ...
 private:
  ...
  ::rapidproto::ArrayView<::rp::enums::p3::State> m_states;
...
RP_FLATTEN RP_NOINLINE inline bool ::rp::arena::p3::Msg::rp_decode_into([[maybe_unused]] ::rp::arena::p3::Msg& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  ::rp::enums::p3::State* rp_acc_states = nullptr;
  std::size_t rp_n_states = 0;
  std::size_t rp_cap_states = 0;
  const auto rp_slot_states = [&]() noexcept -> ::rp::enums::p3::State* {
    if (rp_n_states == rp_cap_states) {
      const std::size_t rp_nc = rp_cap_states == 0 ? std::size_t{4} : rp_cap_states * 2;
      ::rp::enums::p3::State* const rp_nb = arena.allocate_array<::rp::enums::p3::State>(rp_nc);
      if (rp_nb == nullptr) { return nullptr; }
  ...
  for (;;) {
    ...
    rp_do_4: {
      ...
      if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - ::rapidproto::wire::byte_ptr(body))); return false; }
      rp_c = rp_np;
      out.m_state = static_cast<::rp::enums::p3::State>(::rapidproto::varint_to_int32(rp_raw));
      if (rp_c < rp_cend && *rp_c == ::rapidproto::raw_tag(5, ::rapidproto::WireType::Len)) { ++rp_c; goto rp_do_5; }
    ...
    rp_do_8: {
      ::rp::enums::p3::State* const rp_slot = rp_slot_states();
      if (rp_slot == nullptr) { ::rapidproto::rp_fail_oom(err); return false; }
      std::uint64_t rp_raw = 0;
      const std::uint8_t* const rp_np = ::rapidproto::wire::read_varint(rp_c, rp_cend, &rp_raw, &rp_we);
      if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - ::rapidproto::wire::byte_ptr(body))); return false; }
      rp_c = rp_np;
      *rp_slot = static_cast<::rp::enums::p3::State>(::rapidproto::varint_to_int32(rp_raw));
    ...
    rp_do_8_p: {
      ...
      const std::uint8_t* const rp_ve = rp_vp + rp_p.size();
      if (rp_p.size() >= 256) {
        const std::size_t rp_dc = ::rapidproto::arena_detail::decode_packed_varints_large<::rp::enums::p3::State, ::rapidproto::wire::conv_enum<::rp::enums::p3::State>>(rp_vp, rp_ve, rp_acc_states + rp_n_states, err);
        if (rp_dc == static_cast<std::size_t>(-1)) { return false; }
        rp_n_states += rp_dc;
      } else {
        const std::size_t rp_dc = ::rapidproto::arena_detail::decode_packed_varints_small<::rp::enums::p3::State, ::rapidproto::wire::conv_enum<::rp::enums::p3::State>>(rp_vp, rp_ve, rp_acc_states + rp_n_states, err);
        if (rp_dc == static_cast<std::size_t>(-1)) { return false; }
        rp_n_states += rp_dc;
      }
      arena.shrink_last(rp_acc_states, rp_cap_states * sizeof(::rp::enums::p3::State), rp_n_states * sizeof(::rp::enums::p3::State));
  ...
  out.m_states = ::rapidproto::ArrayView<::rp::enums::p3::State>(rp_acc_states, rp_n_states);
