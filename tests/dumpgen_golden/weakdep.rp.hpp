...
class WDep {
 ...
 private:
  ...
  static const std::uint8_t* rp_decode_into(WDep& out, const std::uint8_t* rp_c, const std::uint8_t* rp_cend, const std::uint8_t* rp_beg, std::uint32_t rp_term, ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept;
  std::int32_t m_v;
...
RP_FLATTEN inline const std::uint8_t* ::rp::arena::wd::WDep::rp_decode_into([[maybe_unused]] ::rp::arena::wd::WDep& out, const std::uint8_t* rp_c, const std::uint8_t* const rp_cend, const std::uint8_t* const rp_beg, const std::uint32_t rp_term, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
...
inline const ::rp::arena::wd::WDep* ::rp::arena::wd::WDep::decode(::rapidproto::ByteView input, ::rapidproto::Arena& arena, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (input.size() > UINT32_MAX) { ::rapidproto::rp_fail_input_too_large(err); return nullptr; }
  ::rp::arena::wd::WDep* const rp_root = arena.create<::rp::arena::wd::WDep>();
