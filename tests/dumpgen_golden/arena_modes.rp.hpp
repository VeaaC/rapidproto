...
class Blob {
 public:
  using Kind = ::rp::common::fm::Blob::Kind;
  ...
  std::optional<::rp::common::fm::Blob::Kind> kind() const noexcept { return (m_rp_mask & (std::uint8_t{1} << 1)) != 0 ? std::optional<::rp::common::fm::Blob::Kind>(m_kind) : std::nullopt; }
 ...
 private:
  ...
  static const std::uint8_t* rp_decode_into(Blob& out, const std::uint8_t* rp_c, const std::uint8_t* rp_cend, const std::uint8_t* rp_beg, std::uint32_t rp_term, ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept;
  ::rapidproto::ArenaString m_payload;
  ::rp::common::fm::Blob::Kind m_kind;
 ...
 public:
  ...
  class Grp {
   ...
   private:
    template <class rp_T> friend bool ::rapidproto::arena_detail::decode_into(rp_T&, ::rapidproto::ByteView, ::rapidproto::Arena&, int, ::rapidproto::ArenaDecodeError*) noexcept;
    template <class rp_T> friend const std::uint8_t* ::rapidproto::arena_detail::decode_group_into(rp_T&, const std::uint8_t*, const std::uint8_t*, const std::uint8_t*, std::uint32_t, ::rapidproto::Arena&, int, ::rapidproto::ArenaDecodeError*) noexcept;
    static const std::uint8_t* rp_decode_into(Grp& out, const std::uint8_t* rp_c, const std::uint8_t* rp_cend, const std::uint8_t* rp_beg, std::uint32_t rp_term, ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept;
    std::int32_t m_g;
    std::uint8_t m_rp_mask;
  };
  struct By_nameEntry {
    std::string_view key() const noexcept { return rp_key.view(); }
    const ::rp::arena::fm::Blob* value() const noexcept { return rp_value; }
    friend class Holder;
   private:
    const ::rp::arena::fm::Blob* rp_value;
...
RP_FLATTEN inline const std::uint8_t* ::rp::arena::fm::Blob::rp_decode_into([[maybe_unused]] ::rp::arena::fm::Blob& out, const std::uint8_t* rp_c, const std::uint8_t* const rp_cend, const std::uint8_t* const rp_beg, const std::uint32_t rp_term, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    rp_do_2: {
      ...
      if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - rp_beg)); return nullptr; }
      rp_c = rp_np;
      out.m_kind = static_cast<::rp::common::fm::Blob::Kind>(::rapidproto::varint_to_int32(rp_raw));
...
inline const ::rp::arena::fm::Blob* ::rp::arena::fm::Blob::decode(::rapidproto::ByteView input, ::rapidproto::Arena& arena, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (input.size() > UINT32_MAX) { ::rapidproto::rp_fail_input_too_large(err); return nullptr; }
  ::rp::arena::fm::Blob* const rp_root = arena.create<::rp::arena::fm::Blob>();
...
// NOLINTNEXTLINE(readability-function-cognitive-complexity): generated field dispatch
RP_FLATTEN RP_NOINLINE inline const std::uint8_t* ::rp::arena::fm::Holder::rp_decode_into([[maybe_unused]] ::rp::arena::fm::Holder& out, const std::uint8_t* rp_c, const std::uint8_t* const rp_cend, const std::uint8_t* const rp_beg, const std::uint32_t rp_term, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (depth > ::rapidproto::kMaxDecodeDepth) { ::rapidproto::rp_fail_recursion(err); return nullptr; }
    ...
    switch (rp_tag.field_number) {
      ...
      case 7: {
        if (rp_tag.wire_type == ::rapidproto::WireType::Len) {
          if (out.m_blob.data() != nullptr) { ::rapidproto::rp_fail_repeated_singular(err, 7); return nullptr; }
          ::rapidproto::ByteView rp_v;
      ...
      case 13: {
        if (rp_tag.wire_type == ::rapidproto::WireType::Len) {
          if (out.m_req_blob.data() != nullptr) { ::rapidproto::rp_fail_repeated_singular(err, 13); return nullptr; }
          ::rapidproto::ByteView rp_v;
          { const std::uint8_t* const rp_np = ::rapidproto::wire::read_length_delimited(rp_c, rp_cend, &rp_v, &rp_we); if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - rp_beg)); return nullptr; } rp_c = rp_np; }
      ...
      case 14: {
        if (rp_tag.wire_type == ::rapidproto::WireType::SGroup) {
          if (out.m_grp.data() != nullptr) { ::rapidproto::rp_fail_repeated_singular(err, 14); return nullptr; }
          ::rapidproto::ByteView rp_v;
          { std::size_t rp_fo = 0; const std::uint8_t* const rp_np = ::rapidproto::wire::read_group(rp_c, rp_cend, rp_beg, rp_tag.field_number, &rp_v, &rp_we, &rp_fo); if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, rp_fo); return nullptr; } rp_c = rp_np; }
          ...
          *rp_slot = By_nameEntry{};
          ...
          for (;;) {
            ...
            if (rp_et.field_number == 1 && rp_et.wire_type == ::rapidproto::WireType::Len) {
              ...
              if (rp_vseen) { ::rapidproto::rp_fail_repeated_singular(err, 11); return nullptr; }
              rp_vseen = true;
              ::rapidproto::ByteView rp_v;
              ...
              ::rp::arena::fm::Blob* const rp_mv = arena.create<::rp::arena::fm::Blob>();
  ...
  if ((rp_req & (std::uint64_t{1} << 0)) == 0) { ::rapidproto::rp_fail_missing_required(err, 5); return nullptr; }
  if ((rp_req & (std::uint64_t{1} << 1)) == 0) { ::rapidproto::rp_fail_missing_required(err, 13); return nullptr; }
  return rp_c;
  rp_unterminated:;
  ::rapidproto::rp_fail_wire_at(err, ::rapidproto::WireError::UnterminatedGroup, static_cast<std::size_t>(rp_c - rp_beg));
  return nullptr;
}
inline const ::rp::arena::fm::Holder* ::rp::arena::fm::Holder::decode(::rapidproto::ByteView input, ::rapidproto::Arena& arena, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (input.size() > UINT32_MAX) { ::rapidproto::rp_fail_input_too_large(err); return nullptr; }
  ::rp::arena::fm::Holder* const rp_root = arena.create<::rp::arena::fm::Holder>();
  if (rp_root == nullptr) { ::rapidproto::rp_fail_oom(err); return nullptr; }
  const std::uint8_t* const rp_in = ::rapidproto::arena_detail::non_null_cursor(::rapidproto::wire::byte_ptr(input));
  if (rp_decode_into(*rp_root, rp_in, rp_in + input.size(), rp_in, 0, arena, 0, err) == nullptr) { return nullptr; }
  return rp_root;
...
// NOLINTNEXTLINE(readability-function-cognitive-complexity): generated field dispatch
RP_FLATTEN inline const std::uint8_t* ::rp::arena::fm::Holder::Grp::rp_decode_into([[maybe_unused]] ::rp::arena::fm::Holder::Grp& out, const std::uint8_t* rp_c, const std::uint8_t* const rp_cend, const std::uint8_t* const rp_beg, const std::uint32_t rp_term, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (depth > ::rapidproto::kMaxDecodeDepth) { ::rapidproto::rp_fail_recursion(err); return nullptr; }
  ::rapidproto::Tag rp_tag{};
  ::rapidproto::WireError rp_we = ::rapidproto::WireError::None;
  for (;;) {
...
inline const ::rp::arena::fm::Holder::Grp* ::rp::arena::fm::Holder::Grp::decode(::rapidproto::ByteView input, ::rapidproto::Arena& arena, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (input.size() > UINT32_MAX) { ::rapidproto::rp_fail_input_too_large(err); return nullptr; }
  ::rp::arena::fm::Holder::Grp* const rp_root = arena.create<::rp::arena::fm::Holder::Grp>();
  if (rp_root == nullptr) { ::rapidproto::rp_fail_oom(err); return nullptr; }
  const std::uint8_t* const rp_in = ::rapidproto::arena_detail::non_null_cursor(::rapidproto::wire::byte_ptr(input));
  if (rp_decode_into(*rp_root, rp_in, rp_in + input.size(), rp_in, 0, arena, 0, err) == nullptr) { return nullptr; }
  return rp_root;
