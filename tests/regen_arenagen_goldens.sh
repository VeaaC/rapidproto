...
# --unknown-present: a single-bool wrapper field is a normal inlined sub-message carrying its own
...
# the name pattern stale, this printed "0 arenagen goldens regenerated" and exited 0. (A
