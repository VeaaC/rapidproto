...
RP_FLATTEN inline bool FirstA::rp_decode_into([[maybe_unused]] FirstA& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
