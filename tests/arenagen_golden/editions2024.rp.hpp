...
RP_FLATTEN inline bool ::rp::arena::ed24::M::rp_decode_into([[maybe_unused]] ::rp::arena::ed24::M& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
