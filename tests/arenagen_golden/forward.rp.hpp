...
class Fwd {
 ...
 private:
  ...
  static const std::uint8_t* rp_decode_into(Fwd& out, const std::uint8_t* rp_c, const std::uint8_t* rp_cend, const std::uint8_t* rp_beg, std::uint32_t rp_term, ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept;
  std::int32_t m_z;
...
RP_FLATTEN inline const std::uint8_t* ::rp::arena::fwd::Fwd::rp_decode_into([[maybe_unused]] ::rp::arena::fwd::Fwd& out, const std::uint8_t* rp_c, const std::uint8_t* const rp_cend, const std::uint8_t* const rp_beg, const std::uint32_t rp_term, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
...
inline const ::rp::arena::fwd::Fwd* ::rp::arena::fwd::Fwd::decode(::rapidproto::ByteView input, ::rapidproto::Arena& arena, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (input.size() > UINT32_MAX) { ::rapidproto::rp_fail_input_too_large(err); return nullptr; }
  ::rp::arena::fwd::Fwd* const rp_root = arena.create<::rp::arena::fwd::Fwd>();
