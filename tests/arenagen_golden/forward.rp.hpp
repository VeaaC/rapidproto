...
RP_FLATTEN inline bool ::rp::arena::fwd::Fwd::rp_decode_into([[maybe_unused]] ::rp::arena::fwd::Fwd& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
