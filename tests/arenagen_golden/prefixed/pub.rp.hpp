...
class Pub {
 ...
 private:
  ...
  static const std::uint8_t* rp_decode_into(Pub& out, const std::uint8_t* rp_c, const std::uint8_t* rp_cend, const std::uint8_t* rp_beg, std::uint32_t rp_term, ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept;
  std::int32_t m_w;
...
RP_FLATTEN inline const std::uint8_t* ::pfx::arena::pub::Pub::rp_decode_into([[maybe_unused]] ::pfx::arena::pub::Pub& out, const std::uint8_t* rp_c, const std::uint8_t* const rp_cend, const std::uint8_t* const rp_beg, const std::uint32_t rp_term, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
...
inline const ::pfx::arena::pub::Pub* ::pfx::arena::pub::Pub::decode(::rapidproto::ByteView input, ::rapidproto::Arena& arena, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (input.size() > UINT32_MAX) { ::rapidproto::rp_fail_input_too_large(err); return nullptr; }
  ::pfx::arena::pub::Pub* const rp_root = arena.create<::pfx::arena::pub::Pub>();
