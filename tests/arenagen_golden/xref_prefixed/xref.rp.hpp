...
class A {
 public:
  const ::rp::xr::B* b() const noexcept { return m_b.get(); }
 ...
 private:
  ...
  std::int32_t m_id;
  ::rapidproto::ArenaPtr<::rp::xr::B> m_b;
};
static_assert(::std::is_trivially_destructible_v<A>);

class B {
 public:
  const ::rp::xr::A* a() const noexcept { return m_a.get(); }
 ...
 private:
  ...
  ::rapidproto::ArenaPtr<::rp::xr::A> m_a;
};
 ...
 public:
  ...
  class User {
   public:
    ...
    const ::rp::xr::Nested::Def* single() const noexcept { return m_single.get(); }
    ::rapidproto::ArrayView<::rp::xr::Nested::Def> many() const noexcept { return m_many.view(); }
    ::rp::xr::Nested::Def::Kind kind() const noexcept { return m_kind; }
    ::rapidproto::ArrayView<::rp::xr::Nested::Def::Kind> kinds() const noexcept { return m_kinds.view(); }
    const ::rp::xr::Nested::Def::Inner* inner() const noexcept { return m_inner.get(); }
    ::rapidproto::ArrayView<::rp::xr::Nested::Def::Inner> inners() const noexcept { return m_inners.view(); }
    ::rapidproto::MapView<By_nameEntry> by_name() const noexcept { return ::rapidproto::MapView<By_nameEntry>(m_by_name.view()); }
    ::rapidproto::MapView<RankedEntry> ranked() const noexcept { return ::rapidproto::MapView<RankedEntry>(m_ranked.view()); }
    template <class... RpFs> void pick(RpFs&&... rp_fs) const {
      ...
      switch (m_rp_pick_case) {
        case 1:
          ...
          ::rapidproto::invoke_handler(rp_d, Pick::chosen{}, *m_rp_pick.chosen.get());
          }
          break;
        case 2:
   ...
   private:
    ...
    union rp_pick_union {
      ::rapidproto::ArenaPtr<::rp::xr::Nested::Def> chosen;
      ::rp::xr::Nested::Def::Kind tagged;
      rp_pick_union() noexcept {}
    };
    rp_pick_union m_rp_pick;
    ::rp::xr::Nested::Def::Kind m_kind;
    ::rapidproto::ArenaArray<::rp::xr::Nested::Def> m_many;
    ::rapidproto::ArenaArray<By_nameEntry> m_by_name;
    ::rapidproto::ArenaArray<::rp::xr::Nested::Def::Kind> m_kinds;
    ::rapidproto::ArenaArray<RankedEntry> m_ranked;
    ::rapidproto::ArenaArray<::rp::xr::Nested::Def::Inner> m_inners;
    ::rapidproto::ArenaPtr<::rp::xr::Nested::Def> m_single;
    ::rapidproto::ArenaPtr<::rp::xr::Nested::Def::Inner> m_inner;
    std::uint8_t m_rp_pick_case;
  };
  class P {
   public:
    const ::rp::xr::Nested::Q* q() const noexcept { return m_q.get(); }
   ...
   private:
    ...
    ::rapidproto::ArenaPtr<::rp::xr::Nested::Q> m_q;
  };
  class Q {
   public:
    const ::rp::xr::Nested::P* p() const noexcept { return m_p.get(); }
   ...
   private:
    ...
    ::rapidproto::ArenaPtr<::rp::xr::Nested::P> m_p;
  };
 ...
 public:
  ...
  class Ref {
   public:
    ...
    const ::rp::xr::FwdMsg::Target* one() const noexcept { return m_one.get(); }
    ::rapidproto::ArrayView<::rp::xr::FwdMsg::Target> many() const noexcept { return m_many.view(); }
    ::rapidproto::MapView<By_idEntry> by_id() const noexcept { return ::rapidproto::MapView<By_idEntry>(m_by_id.view()); }
    template <class... RpFs> void pick(RpFs&&... rp_fs) const {
      static_assert((0U + ... + static_cast<unsigned>(::rapidproto::specifically_handles<RpFs, Pick::chosen, typename Pick::chosen::Value>)) <= 1U, "oneof member 'chosen' is handled by more than one callback");
      static_assert((0U + ... + static_cast<unsigned>(::rapidproto::is_catch_all<RpFs, Pick::chosen, typename Pick::chosen::Value>)) <= 1U, "oneof member 'chosen' is matched by more than one catch-all callback");
      static_assert((true && ... && !::rapidproto::is_partial_generic<RpFs, Pick::chosen, typename Pick::chosen::Value>), "a callback for oneof member 'chosen' is partially generic; use a concrete (Tag, Value) callback or a fully generic (auto, auto) catch-all");
   ...
   private:
    ...
    union rp_pick_union {
      ::rapidproto::ArenaPtr<::rp::xr::FwdMsg::Target> chosen;
      rp_pick_union() noexcept {}
    };
    ::rapidproto::ArenaArray<::rp::xr::FwdMsg::Target> m_many;
    ::rapidproto::ArenaArray<By_idEntry> m_by_id;
    ::rapidproto::ArenaPtr<::rp::xr::FwdMsg::Target> m_one;
    rp_pick_union m_rp_pick;
    std::uint8_t m_rp_pick_case;
  };
  class Target {
...
class CousinA {
 public:
  ...
  class Use {
   public:
    const ::rp::xr::CousinB::Thing* thing() const noexcept { return m_thing.get(); }
    ::rapidproto::ArrayView<::rp::xr::CousinB::Thing> things() const noexcept { return m_things.view(); }
   ...
   private:
    ...
    ::rapidproto::ArenaArray<::rp::xr::CousinB::Thing> m_things;
    ::rapidproto::ArenaPtr<::rp::xr::CousinB::Thing> m_thing;
  };
...
RP_FLATTEN inline bool A::rp_decode_into([[maybe_unused]] A& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    rp_do_1: {
      if (out.m_b.is_set()) { ::rapidproto::rp_fail_repeated_singular(err, 1); return false; }
      ...
      ::rapidproto::ArenaPtr<::rp::xr::B>::store(&out.m_b, rp_sub);
...
RP_FLATTEN inline bool B::rp_decode_into([[maybe_unused]] B& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    goto rp_field_general;
    rp_do_1: {
      if (out.m_a.is_set()) { ::rapidproto::rp_fail_repeated_singular(err, 1); return false; }
      ::rapidproto::ByteView rp_v;
      { const std::uint8_t* const rp_np = ::rapidproto::wire::read_length_delimited(rp_c, rp_cend, &rp_v, &rp_we); if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - ::rapidproto::wire::byte_ptr(body))); return false; } rp_c = rp_np; }
      ::rp::xr::A* const rp_sub = arena.create<::rp::xr::A>();
      if (rp_sub == nullptr) { ::rapidproto::rp_fail_oom(err); return false; }
      if (!::rapidproto::arena_detail::decode_into(*rp_sub, rp_v, arena, depth + 1, err)) { return false; }
      ::rapidproto::ArenaPtr<::rp::xr::A>::store(&out.m_a, rp_sub);
      continue;
    }
    rp_field_general:;
    ::rapidproto::wire::TagState rp_state = ::rapidproto::wire::TagState::End;
...
RP_FLATTEN inline bool Nested::User::rp_decode_into([[maybe_unused]] Nested::User& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    goto rp_field_general;
    rp_do_1: {
      if (out.m_single.is_set()) { ::rapidproto::rp_fail_repeated_singular(err, 1); return false; }
      ::rapidproto::ByteView rp_v;
      { const std::uint8_t* const rp_np = ::rapidproto::wire::read_length_delimited(rp_c, rp_cend, &rp_v, &rp_we); if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - ::rapidproto::wire::byte_ptr(body))); return false; } rp_c = rp_np; }
      ::rp::xr::Nested::Def* const rp_sub = arena.create<::rp::xr::Nested::Def>();
      if (rp_sub == nullptr) { ::rapidproto::rp_fail_oom(err); return false; }
      if (!::rapidproto::arena_detail::decode_into(*rp_sub, rp_v, arena, depth + 1, err)) { return false; }
      ::rapidproto::ArenaPtr<::rp::xr::Nested::Def>::store(&out.m_single, rp_sub);
    ...
    rp_do_6_p: {
      ...
      if (rp_p.size() >= 256) {
        const std::size_t rp_dc = ::rapidproto::arena_detail::decode_packed_varints_large<::rp::xr::Nested::Def::Kind, ::rapidproto::wire::conv_enum<::rp::xr::Nested::Def::Kind>>(rp_vp, rp_ve, rp_acc_kinds + rp_n_kinds, err);
        if (rp_dc == static_cast<std::size_t>(-1)) { return false; }
        rp_n_kinds += rp_dc;
      } else {
        const std::size_t rp_dc = ::rapidproto::arena_detail::decode_packed_varints_small<::rp::xr::Nested::Def::Kind, ::rapidproto::wire::conv_enum<::rp::xr::Nested::Def::Kind>>(rp_vp, rp_ve, rp_acc_kinds + rp_n_kinds, err);
        if (rp_dc == static_cast<std::size_t>(-1)) { return false; }
        rp_n_kinds += rp_dc;
      }
    ...
    rp_do_9: {
      if (out.m_inner.is_set()) { ::rapidproto::rp_fail_repeated_singular(err, 9); return false; }
      ::rapidproto::ByteView rp_v;
      { const std::uint8_t* const rp_np = ::rapidproto::wire::read_length_delimited(rp_c, rp_cend, &rp_v, &rp_we); if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - ::rapidproto::wire::byte_ptr(body))); return false; } rp_c = rp_np; }
      ::rp::xr::Nested::Def::Inner* const rp_sub = arena.create<::rp::xr::Nested::Def::Inner>();
      if (rp_sub == nullptr) { ::rapidproto::rp_fail_oom(err); return false; }
      if (!::rapidproto::arena_detail::decode_into(*rp_sub, rp_v, arena, depth + 1, err)) { return false; }
      ::rapidproto::ArenaPtr<::rp::xr::Nested::Def::Inner>::store(&out.m_inner, rp_sub);
      if (rp_c < rp_cend && *rp_c == ::rapidproto::raw_tag(10, ::rapidproto::WireType::Len)) { ++rp_c; goto rp_do_10; }
      continue;
    }
    rp_do_10: {
    ...
    switch (rp_tag.field_number) {
      ...
      case 4: {
        if (rp_tag.wire_type == ::rapidproto::WireType::Len) {
          ...
          if (rp_sub == nullptr) { ::rapidproto::rp_fail_oom(err); return false; }
          if (!::rapidproto::arena_detail::decode_into(*rp_sub, rp_v, arena, depth + 1, err)) { return false; }
          ::rapidproto::ArenaPtr<::rp::xr::Nested::Def>::store(&out.m_rp_pick.chosen, rp_sub);
  ...
  ::rapidproto::ArenaArray<::rp::xr::Nested::Def>::store(&out.m_many, rp_acc_many, rp_n_many);
  ::rapidproto::ArenaArray<::rp::xr::Nested::Def::Kind>::store(&out.m_kinds, rp_acc_kinds, rp_n_kinds);
  ::rapidproto::ArenaArray<::rp::xr::Nested::Def::Inner>::store(&out.m_inners, rp_acc_inners, rp_n_inners);
  ::rapidproto::ArenaArray<By_nameEntry>::store(&out.m_by_name, rp_acc_by_name, rp_n_by_name);
  ::rapidproto::ArenaArray<RankedEntry>::store(&out.m_ranked, rp_acc_ranked, rp_n_ranked);
  return true;
}
...
RP_FLATTEN inline bool Nested::P::rp_decode_into([[maybe_unused]] Nested::P& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    goto rp_field_general;
    rp_do_1: {
      if (out.m_q.is_set()) { ::rapidproto::rp_fail_repeated_singular(err, 1); return false; }
      ::rapidproto::ByteView rp_v;
      { const std::uint8_t* const rp_np = ::rapidproto::wire::read_length_delimited(rp_c, rp_cend, &rp_v, &rp_we); if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - ::rapidproto::wire::byte_ptr(body))); return false; } rp_c = rp_np; }
      ::rp::xr::Nested::Q* const rp_sub = arena.create<::rp::xr::Nested::Q>();
      if (rp_sub == nullptr) { ::rapidproto::rp_fail_oom(err); return false; }
      if (!::rapidproto::arena_detail::decode_into(*rp_sub, rp_v, arena, depth + 1, err)) { return false; }
      ::rapidproto::ArenaPtr<::rp::xr::Nested::Q>::store(&out.m_q, rp_sub);
      continue;
    }
    rp_field_general:;
    ::rapidproto::wire::TagState rp_state = ::rapidproto::wire::TagState::End;
...
RP_FLATTEN inline bool Nested::Q::rp_decode_into([[maybe_unused]] Nested::Q& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    goto rp_field_general;
    rp_do_1: {
      if (out.m_p.is_set()) { ::rapidproto::rp_fail_repeated_singular(err, 1); return false; }
      ::rapidproto::ByteView rp_v;
      { const std::uint8_t* const rp_np = ::rapidproto::wire::read_length_delimited(rp_c, rp_cend, &rp_v, &rp_we); if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - ::rapidproto::wire::byte_ptr(body))); return false; } rp_c = rp_np; }
      ::rp::xr::Nested::P* const rp_sub = arena.create<::rp::xr::Nested::P>();
      if (rp_sub == nullptr) { ::rapidproto::rp_fail_oom(err); return false; }
      if (!::rapidproto::arena_detail::decode_into(*rp_sub, rp_v, arena, depth + 1, err)) { return false; }
      ::rapidproto::ArenaPtr<::rp::xr::Nested::P>::store(&out.m_p, rp_sub);
      continue;
    }
    rp_field_general:;
    ::rapidproto::wire::TagState rp_state = ::rapidproto::wire::TagState::End;
...
RP_FLATTEN inline bool FwdMsg::Ref::rp_decode_into([[maybe_unused]] FwdMsg::Ref& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    goto rp_field_general;
    rp_do_1: {
      if (out.m_one.is_set()) { ::rapidproto::rp_fail_repeated_singular(err, 1); return false; }
      ::rapidproto::ByteView rp_v;
      { const std::uint8_t* const rp_np = ::rapidproto::wire::read_length_delimited(rp_c, rp_cend, &rp_v, &rp_we); if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - ::rapidproto::wire::byte_ptr(body))); return false; } rp_c = rp_np; }
      ::rp::xr::FwdMsg::Target* const rp_sub = arena.create<::rp::xr::FwdMsg::Target>();
      if (rp_sub == nullptr) { ::rapidproto::rp_fail_oom(err); return false; }
      if (!::rapidproto::arena_detail::decode_into(*rp_sub, rp_v, arena, depth + 1, err)) { return false; }
      ::rapidproto::ArenaPtr<::rp::xr::FwdMsg::Target>::store(&out.m_one, rp_sub);
      if (rp_c < rp_cend && *rp_c == ::rapidproto::raw_tag(2, ::rapidproto::WireType::Len)) { ++rp_c; goto rp_do_2; }
      continue;
    }
    rp_do_2: {
    ...
    switch (rp_tag.field_number) {
      ...
      case 4: {
        if (rp_tag.wire_type == ::rapidproto::WireType::Len) {
          ...
          if (rp_sub == nullptr) { ::rapidproto::rp_fail_oom(err); return false; }
          if (!::rapidproto::arena_detail::decode_into(*rp_sub, rp_v, arena, depth + 1, err)) { return false; }
          ::rapidproto::ArenaPtr<::rp::xr::FwdMsg::Target>::store(&out.m_rp_pick.chosen, rp_sub);
          out.m_rp_pick_case = 1;
          continue;
        }
        break;
  ...
  ::rapidproto::ArenaArray<::rp::xr::FwdMsg::Target>::store(&out.m_many, rp_acc_many, rp_n_many);
  ::rapidproto::ArenaArray<By_idEntry>::store(&out.m_by_id, rp_acc_by_id, rp_n_by_id);
  return true;
}
...
RP_FLATTEN inline bool CousinA::Use::rp_decode_into([[maybe_unused]] CousinA::Use& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    goto rp_field_general;
    rp_do_1: {
      if (out.m_thing.is_set()) { ::rapidproto::rp_fail_repeated_singular(err, 1); return false; }
      ::rapidproto::ByteView rp_v;
      { const std::uint8_t* const rp_np = ::rapidproto::wire::read_length_delimited(rp_c, rp_cend, &rp_v, &rp_we); if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - ::rapidproto::wire::byte_ptr(body))); return false; } rp_c = rp_np; }
      ::rp::xr::CousinB::Thing* const rp_sub = arena.create<::rp::xr::CousinB::Thing>();
      if (rp_sub == nullptr) { ::rapidproto::rp_fail_oom(err); return false; }
      if (!::rapidproto::arena_detail::decode_into(*rp_sub, rp_v, arena, depth + 1, err)) { return false; }
      ::rapidproto::ArenaPtr<::rp::xr::CousinB::Thing>::store(&out.m_thing, rp_sub);
      if (rp_c < rp_cend && *rp_c == ::rapidproto::raw_tag(2, ::rapidproto::WireType::Len)) { ++rp_c; goto rp_do_2; }
  ...
  ::rapidproto::ArenaArray<::rp::xr::CousinB::Thing>::store(&out.m_things, rp_acc_things, rp_n_things);
  return true;
}
...
RP_FLATTEN inline bool BytesWrap::rp_decode_into([[maybe_unused]] BytesWrap& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    rp_do_1: {
      ...
      if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - ::rapidproto::wire::byte_ptr(body))); return false; }
      rp_c = rp_np;
      ::rapidproto::ArenaString::store(&out.m_value, rp_v);
      continue;
    }
    rp_field_general:;
    ::rapidproto::wire::TagState rp_state = ::rapidproto::wire::TagState::End;
