  ...
  for (;;) {
    ...
    switch (*rp_c) {  // peek the 1-byte tag without consuming
      ...
      case ::rapidproto::raw_tag(6, ::rapidproto::WireType::Len): {
        ...
        std::size_t rp_fo = 0;
        const std::size_t rp_dc = ::rapidproto::wire::decode_packed_varints<::rp::xr::Nested::Def::Kind>(rp_vp, rp_ve, rp_acc_kinds + rp_n_kinds, rp_vp, &rp_we, &rp_fo, ::rapidproto::wire::conv_enum<::rp::xr::Nested::Def::Kind>{});
