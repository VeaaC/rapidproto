...
RP_FLATTEN inline bool Msg::rp_decode_into([[maybe_unused]] Msg& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    switch (*rp_c) {  // peek the 1-byte tag without consuming
      ...
      case ::rapidproto::raw_tag(3, ::rapidproto::WireType::Len): {
        ++rp_c;  // consume the peeked 1-byte tag
      ...
      case ::rapidproto::raw_tag(7, ::rapidproto::WireType::Len): {
        ...
        while (rp_vp < rp_ve) {
          ...
          const std::uint8_t* const rp_np = ::rapidproto::vt_read_varint(rp_vp, rp_ve, &rp_raw, &rp_we);
          if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_vp - rp_vbeg)); return false; }
          rp_acc_unpacked[rp_n_unpacked] = ::rapidproto::varint_to_int32(rp_raw);
          ++rp_n_unpacked;
          rp_vp = rp_np;
        }
      ...
      case ::rapidproto::raw_tag(8, ::rapidproto::WireType::Len): {
        ++rp_c;  // consume the peeked 1-byte tag
        ::rapidproto::ByteView rp_p;
        { const std::uint8_t* const rp_np = ::rapidproto::vt_read_length_delimited(rp_c, rp_cend, &rp_p, &rp_we); if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - ::rapidproto::byte_ptr(body))); return false; } rp_c = rp_np; }
        const std::size_t rp_ub = rp_p.size();
      ...
      case ::rapidproto::raw_tag(12, ::rapidproto::WireType::I64): {
        ++rp_c;  // consume the peeked 1-byte tag
      ...
      case ::rapidproto::raw_tag(12, ::rapidproto::WireType::Len): {
        ...
        while (rp_vp < rp_ve) {
          std::uint64_t rp_raw = 0;
          const std::uint8_t* const rp_np = ::rapidproto::vt_read_fixed64(rp_vp, rp_ve, &rp_raw, &rp_we);
          if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_vp - rp_vbeg)); return false; }
          rp_vp = rp_np;
      ...
      case ::rapidproto::raw_tag(13, ::rapidproto::WireType::I32): {
        ++rp_c;  // consume the peeked 1-byte tag
      ...
      case ::rapidproto::raw_tag(13, ::rapidproto::WireType::Len): {
        ...
        while (rp_vp < rp_ve) {
          std::uint32_t rp_raw = 0;
          const std::uint8_t* const rp_np = ::rapidproto::vt_read_fixed32(rp_vp, rp_ve, &rp_raw, &rp_we);
          if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_vp - rp_vbeg)); return false; }
          rp_vp = rp_np;
