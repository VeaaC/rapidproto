...
class AllWire {
 public:
  ...
  template <class... rp_Fs> void pick(rp_Fs&&... rp_fs) const {
    static_assert((0U + ... + static_cast<unsigned>(::rapidproto::specifically_handles<rp_Fs, Pick::oi, typename Pick::oi::Value>)) <= 1U, "oneof member '::rp::arena::wire::AllWire::oi' is handled by more than one callback");
    static_assert((0U + ... + static_cast<unsigned>(::rapidproto::is_catch_all<rp_Fs, Pick::oi, typename Pick::oi::Value>)) <= 1U, "oneof member '::rp::arena::wire::AllWire::oi' is matched by more than one catch-all callback");
    static_assert((true && ... && !::rapidproto::is_partial_generic<rp_Fs, Pick::oi, typename Pick::oi::Value>), "a callback for oneof member '::rp::arena::wire::AllWire::oi' is partially generic; use a concrete (Tag, Value) callback or a fully generic (auto, auto) catch-all");
    static_assert((true && ... && !(::rapidproto::targets<rp_Fs, Pick::oi, typename Pick::oi::Value> && !::rapidproto::specifically_handles<rp_Fs, Pick::oi, typename Pick::oi::Value>)), "a callback for oneof member '::rp::arena::wire::AllWire::oi' has the wrong value type (expected Pick::oi::Value)");
    static_assert((0U + ... + static_cast<unsigned>(::rapidproto::specifically_handles<rp_Fs, Pick::os, typename Pick::os::Value>)) <= 1U, "oneof member '::rp::arena::wire::AllWire::os' is handled by more than one callback");
    static_assert((0U + ... + static_cast<unsigned>(::rapidproto::is_catch_all<rp_Fs, Pick::os, typename Pick::os::Value>)) <= 1U, "oneof member '::rp::arena::wire::AllWire::os' is matched by more than one catch-all callback");
    static_assert((true && ... && !::rapidproto::is_partial_generic<rp_Fs, Pick::os, typename Pick::os::Value>), "a callback for oneof member '::rp::arena::wire::AllWire::os' is partially generic; use a concrete (Tag, Value) callback or a fully generic (auto, auto) catch-all");
    static_assert((true && ... && !(::rapidproto::targets<rp_Fs, Pick::os, typename Pick::os::Value> && !::rapidproto::specifically_handles<rp_Fs, Pick::os, typename Pick::os::Value>)), "a callback for oneof member '::rp::arena::wire::AllWire::os' has the wrong value type (expected Pick::os::Value)");
...
RP_FLATTEN RP_NOINLINE inline bool ::rp::arena::wire::AllWire::rp_decode_into([[maybe_unused]] ::rp::arena::wire::AllWire& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
...
// NOLINTNEXTLINE(readability-function-cognitive-complexity): generated field dispatch
RP_FLATTEN inline bool ::rp::arena::wire::AllWire::G::rp_decode_into([[maybe_unused]] ::rp::arena::wire::AllWire::G& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (depth > ::rapidproto::kMaxDecodeDepth) { ::rapidproto::rp_fail_recursion(err); return false; }
  const std::uint8_t* rp_c = ::rapidproto::wire::byte_ptr(body);
  const std::uint8_t* const rp_cend = rp_c + body.size();
  ::rapidproto::Tag rp_tag{};
