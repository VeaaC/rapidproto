...
class Holder {
 public:
  ...
  ::rapidproto::StringArrayView blobs() const noexcept { return ::rapidproto::StringArrayView(m_blobs.view()); }
  ::rapidproto::ArrayView<std::int32_t> samples() const noexcept { return m_samples.view(); }
  ::rapidproto::ArrayView<std::int32_t> spread() const noexcept { return m_spread.view(); }
 ...
 private:
  ...
  ::rapidproto::ArenaArray<::rapidproto::ArenaString> m_blobs;
  ::rapidproto::ArenaArray<std::int32_t> m_samples;
  ::rapidproto::ArenaArray<std::int32_t> m_spread;
...
RP_FLATTEN inline bool Blob::rp_decode_into([[maybe_unused]] Blob& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    rp_do_1: {
      ...
      rp_c = rp_np;
      ::rapidproto::ArenaString::store(&out.m_payload, rp_v);
...
RP_FLATTEN inline bool Holder::rp_decode_into([[maybe_unused]] Holder& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
    ...
    switch (rp_tag.field_number) {
      ...
      case 7: {
        if (rp_tag.wire_type == ::rapidproto::WireType::Len) {
          ...
          ::rapidproto::ArenaString::store(&out.m_blob, rp_v);
          continue;
        }
        break;
      }
      ...
      case 13: {
        if (rp_tag.wire_type == ::rapidproto::WireType::Len) {
          ...
          ::rapidproto::ByteView rp_v;
          { const std::uint8_t* const rp_np = ::rapidproto::wire::read_length_delimited(rp_c, rp_cend, &rp_v, &rp_we); if (rp_np == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, static_cast<std::size_t>(rp_c - ::rapidproto::wire::byte_ptr(body))); return false; } rp_c = rp_np; }
          ::rapidproto::ArenaString::store(&out.m_req_blob, rp_v);
      ...
      case 14: {
        if (rp_tag.wire_type == ::rapidproto::WireType::SGroup) {
          ...
          ::rapidproto::ArenaString::store(&out.m_grp, rp_v);
          continue;
        }
        break;
      }
  ...
  ::rapidproto::ArenaArray<::rapidproto::ArenaString>::store(&out.m_blobs, rp_acc_blobs, rp_n_blobs);
  ::rapidproto::ArenaArray<std::int32_t>::store(&out.m_samples, rp_acc_samples, rp_n_samples);
  ::rapidproto::ArenaArray<std::int32_t>::store(&out.m_spread, rp_acc_spread, rp_n_spread);
