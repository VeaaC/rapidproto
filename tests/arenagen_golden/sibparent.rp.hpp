...
class logging {
 ...
 private:
  ...
  static bool rp_decode_into(logging& out, ::rapidproto::ByteView body, ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept;
  std::int32_t m_x;
};
...
RP_FLATTEN inline bool ::rp::arena::sib::logging::rp_decode_into([[maybe_unused]] ::rp::arena::sib::logging& out, ::rapidproto::ByteView body, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
