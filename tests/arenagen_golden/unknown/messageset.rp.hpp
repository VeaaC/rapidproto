...
class Outer {
 public:
  ...
  class Container {
   public:
    bool has_unknown_fields() const noexcept { return (m_rp_mask & (std::uint8_t{1} << 0)) != 0; }
  ...
  const ::unk::arena::ms::Outer::Container* container() const noexcept { return (m_rp_mask & (std::uint8_t{1} << 1)) != 0 ? &m_container : nullptr; }
  bool has_unknown_fields() const noexcept { return (m_rp_mask & (std::uint8_t{1} << 2)) != 0; }
 ...
 private:
  ...
  ::unk::arena::ms::Outer::Container m_container;
  std::uint8_t m_rp_mask;
};
...
RP_FLATTEN inline const std::uint8_t* ::unk::arena::ms::Outer::rp_decode_into([[maybe_unused]] ::unk::arena::ms::Outer& out, const std::uint8_t* rp_c, const std::uint8_t* const rp_cend, const std::uint8_t* const rp_beg, const std::uint32_t rp_term, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  ...
  for (;;) {
    ...
    switch (rp_tag.field_number) {
      ...
      default: { out.m_rp_mask = static_cast<std::uint8_t>(out.m_rp_mask | (std::uint8_t{1} << 2)); break; }
    }
    std::size_t rp_fo = 0;
...
inline const ::unk::arena::ms::Outer* ::unk::arena::ms::Outer::decode(::rapidproto::ByteView input, ::rapidproto::Arena& arena, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (input.size() > UINT32_MAX) { ::rapidproto::rp_fail_input_too_large(err); return nullptr; }
  ::unk::arena::ms::Outer* const rp_root = arena.create<::unk::arena::ms::Outer>();
...
// NOLINTNEXTLINE(readability-function-cognitive-complexity): generated field dispatch
RP_FLATTEN inline const std::uint8_t* ::unk::arena::ms::Outer::Container::rp_decode_into([[maybe_unused]] ::unk::arena::ms::Outer::Container& out, const std::uint8_t* rp_c, const std::uint8_t* const rp_cend, const std::uint8_t* const rp_beg, const std::uint32_t rp_term, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (depth > ::rapidproto::kMaxDecodeDepth) { ::rapidproto::rp_fail_recursion(err); return nullptr; }
  ::rapidproto::Tag rp_tag{};
  ::rapidproto::WireError rp_we = ::rapidproto::WireError::None;
  for (;;) {
    ...
    rp_c = rp_tp;
    switch (rp_tag.field_number) {
      default: { out.m_rp_mask = static_cast<std::uint8_t>(out.m_rp_mask | (std::uint8_t{1} << 0)); break; }
    }
    std::size_t rp_fo = 0;
    const std::uint8_t* const rp_sp = ::rapidproto::wire::skip_value(rp_c, rp_cend, rp_beg, rp_tag, 0, &rp_we, &rp_fo);
    if (rp_sp == nullptr) { ::rapidproto::rp_fail_wire_at(err, rp_we, rp_fo); return nullptr; }
...
inline const ::unk::arena::ms::Outer::Container* ::unk::arena::ms::Outer::Container::decode(::rapidproto::ByteView input, ::rapidproto::Arena& arena, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (input.size() > UINT32_MAX) { ::rapidproto::rp_fail_input_too_large(err); return nullptr; }
  ::unk::arena::ms::Outer::Container* const rp_root = arena.create<::unk::arena::ms::Outer::Container>();
  if (rp_root == nullptr) { ::rapidproto::rp_fail_oom(err); return nullptr; }
  const std::uint8_t* const rp_in = ::rapidproto::arena_detail::non_null_cursor(::rapidproto::wire::byte_ptr(input));
  if (rp_decode_into(*rp_root, rp_in, rp_in + input.size(), rp_in, 0, arena, 0, err) == nullptr) { return nullptr; }
  return rp_root;
...
// NOLINTNEXTLINE(readability-function-cognitive-complexity): generated field dispatch
RP_FLATTEN inline const std::uint8_t* ::unk::arena::ms::Ext::rp_decode_into([[maybe_unused]] ::unk::arena::ms::Ext& out, const std::uint8_t* rp_c, const std::uint8_t* const rp_cend, const std::uint8_t* const rp_beg, const std::uint32_t rp_term, [[maybe_unused]] ::rapidproto::Arena& arena, int depth, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (depth > ::rapidproto::kMaxDecodeDepth) { ::rapidproto::rp_fail_recursion(err); return nullptr; }
  ::rapidproto::Tag rp_tag{};
  ::rapidproto::WireError rp_we = ::rapidproto::WireError::None;
  for (;;) {
...
inline const ::unk::arena::ms::Ext* ::unk::arena::ms::Ext::decode(::rapidproto::ByteView input, ::rapidproto::Arena& arena, ::rapidproto::ArenaDecodeError* err) noexcept {
  if (input.size() > UINT32_MAX) { ::rapidproto::rp_fail_input_too_large(err); return nullptr; }
  ::unk::arena::ms::Ext* const rp_root = arena.create<::unk::arena::ms::Ext>();
  if (rp_root == nullptr) { ::rapidproto::rp_fail_oom(err); return nullptr; }
  const std::uint8_t* const rp_in = ::rapidproto::arena_detail::non_null_cursor(::rapidproto::wire::byte_ptr(input));
  if (rp_decode_into(*rp_root, rp_in, rp_in + input.size(), rp_in, 0, arena, 0, err) == nullptr) { return nullptr; }
  return rp_root;
