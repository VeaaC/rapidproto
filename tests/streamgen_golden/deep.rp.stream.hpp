...
RP_FLATTEN ::rapidproto::DecodeStatus Outer::decode(rp_Callbacks&&... rp_callbacks) const {
  static_assert((true && ... && !::rapidproto::is_stray_callback<rp_Callbacks, inner, self, mode>), "a callback matches no field of '::rp::stream::com::example::deep::Outer' (and is not a catch-all or unknown-field handler)");
  ...
  for (;;) {
    ...
    rp_do_1: {
      static_assert((0U + ... + static_cast<unsigned>(::rapidproto::specifically_handles<rp_Callbacks, inner, inner::Value>)) <= 1U, "field '::rp::stream::com::example::deep::Outer::inner' is handled by more than one callback");
      static_assert((0U + ... + static_cast<unsigned>(::rapidproto::is_catch_all<rp_Callbacks, inner, inner::Value>)) <= 1U, "field '::rp::stream::com::example::deep::Outer::inner' is matched by more than one catch-all callback");
      static_assert((true && ... && !::rapidproto::is_partial_generic<rp_Callbacks, inner, inner::Value>), "a callback for field '::rp::stream::com::example::deep::Outer::inner' is partially generic; use a concrete (Tag, Value) callback or a fully generic (auto, auto) catch-all");
      static_assert((true && ... && !(::rapidproto::targets<rp_Callbacks, inner, inner::Value> && !::rapidproto::specifically_handles<rp_Callbacks, inner, inner::Value>)), "a callback for field '::rp::stream::com::example::deep::Outer::inner' has the wrong value type (expected ::rp::stream::com::example::deep::Outer::inner::Value)");
    ...
    rp_do_2: {
      static_assert((0U + ... + static_cast<unsigned>(::rapidproto::specifically_handles<rp_Callbacks, self, self::Value>)) <= 1U, "field '::rp::stream::com::example::deep::Outer::self' is handled by more than one callback");
      static_assert((0U + ... + static_cast<unsigned>(::rapidproto::is_catch_all<rp_Callbacks, self, self::Value>)) <= 1U, "field '::rp::stream::com::example::deep::Outer::self' is matched by more than one catch-all callback");
      static_assert((true && ... && !::rapidproto::is_partial_generic<rp_Callbacks, self, self::Value>), "a callback for field '::rp::stream::com::example::deep::Outer::self' is partially generic; use a concrete (Tag, Value) callback or a fully generic (auto, auto) catch-all");
      static_assert((true && ... && !(::rapidproto::targets<rp_Callbacks, self, self::Value> && !::rapidproto::specifically_handles<rp_Callbacks, self, self::Value>)), "a callback for field '::rp::stream::com::example::deep::Outer::self' has the wrong value type (expected ::rp::stream::com::example::deep::Outer::self::Value)");
    ...
    rp_do_3: {
      static_assert((0U + ... + static_cast<unsigned>(::rapidproto::specifically_handles<rp_Callbacks, mode, mode::Value>)) <= 1U, "field '::rp::stream::com::example::deep::Outer::mode' is handled by more than one callback");
      static_assert((0U + ... + static_cast<unsigned>(::rapidproto::is_catch_all<rp_Callbacks, mode, mode::Value>)) <= 1U, "field '::rp::stream::com::example::deep::Outer::mode' is matched by more than one catch-all callback");
      static_assert((true && ... && !::rapidproto::is_partial_generic<rp_Callbacks, mode, mode::Value>), "a callback for field '::rp::stream::com::example::deep::Outer::mode' is partially generic; use a concrete (Tag, Value) callback or a fully generic (auto, auto) catch-all");
      static_assert((true && ... && !(::rapidproto::targets<rp_Callbacks, mode, mode::Value> && !::rapidproto::specifically_handles<rp_Callbacks, mode, mode::Value>)), "a callback for field '::rp::stream::com::example::deep::Outer::mode' has the wrong value type (expected ::rp::stream::com::example::deep::Outer::mode::Value)");
      if constexpr ((false || ... || ::rapidproto::handles_one<rp_Callbacks, mode, mode::Value>)) {
...
template <class... rp_Callbacks>
RP_FLATTEN ::rapidproto::DecodeStatus Outer::Inner::decode(rp_Callbacks&&... rp_callbacks) const {
  static_assert((true && ... && !::rapidproto::is_stray_callback<rp_Callbacks, x>), "a callback matches no field of '::rp::stream::com::example::deep::Outer::Inner' (and is not a catch-all or unknown-field handler)");
  [[maybe_unused]] auto rp_dispatch = ::rapidproto::combine(static_cast<rp_Callbacks&&>(rp_callbacks)...);
  const std::uint8_t* rp_c = ::rapidproto::wire::byte_ptr(rp_span);
  const std::uint8_t* const rp_cend = rp_c + rp_span.size();
  ::rapidproto::Tag rp_tag{};
  ...
  for (;;) {
    ...
    goto rp_field_general;
    rp_do_1: {
      static_assert((0U + ... + static_cast<unsigned>(::rapidproto::specifically_handles<rp_Callbacks, x, x::Value>)) <= 1U, "field '::rp::stream::com::example::deep::Outer::Inner::x' is handled by more than one callback");
      static_assert((0U + ... + static_cast<unsigned>(::rapidproto::is_catch_all<rp_Callbacks, x, x::Value>)) <= 1U, "field '::rp::stream::com::example::deep::Outer::Inner::x' is matched by more than one catch-all callback");
      static_assert((true && ... && !::rapidproto::is_partial_generic<rp_Callbacks, x, x::Value>), "a callback for field '::rp::stream::com::example::deep::Outer::Inner::x' is partially generic; use a concrete (Tag, Value) callback or a fully generic (auto, auto) catch-all");
      static_assert((true && ... && !(::rapidproto::targets<rp_Callbacks, x, x::Value> && !::rapidproto::specifically_handles<rp_Callbacks, x, x::Value>)), "a callback for field '::rp::stream::com::example::deep::Outer::Inner::x' has the wrong value type (expected ::rp::stream::com::example::deep::Outer::Inner::x::Value)");
