...
RP_FLATTEN ::rapidproto::DecodeStatus Outer::decode(rp_Callbacks&&... rp_callbacks) const {
  ...
  for (;;) {
    ...
    rp_do_1: {
      ...
      static_assert((true && ... && !(::rapidproto::targets<rp_Callbacks, inner, inner::Value> && !::rapidproto::specifically_handles<rp_Callbacks, inner, inner::Value>)), "a callback for field '::rp::stream::com::example::deep::Outer::inner' has the wrong value type (expected inner::Value)");
    ...
    rp_do_2: {
      ...
      static_assert((true && ... && !(::rapidproto::targets<rp_Callbacks, self, self::Value> && !::rapidproto::specifically_handles<rp_Callbacks, self, self::Value>)), "a callback for field '::rp::stream::com::example::deep::Outer::self' has the wrong value type (expected self::Value)");
    ...
    rp_do_3: {
      ...
      static_assert((true && ... && !(::rapidproto::targets<rp_Callbacks, mode, mode::Value> && !::rapidproto::specifically_handles<rp_Callbacks, mode, mode::Value>)), "a callback for field '::rp::stream::com::example::deep::Outer::mode' has the wrong value type (expected mode::Value)");
...
RP_FLATTEN ::rapidproto::DecodeStatus Outer::Inner::decode(rp_Callbacks&&... rp_callbacks) const {
  ...
  for (;;) {
    ...
    rp_do_1: {
      ...
      static_assert((true && ... && !(::rapidproto::targets<rp_Callbacks, x, x::Value> && !::rapidproto::specifically_handles<rp_Callbacks, x, x::Value>)), "a callback for field '::rp::stream::com::example::deep::Outer::Inner::x' has the wrong value type (expected x::Value)");
