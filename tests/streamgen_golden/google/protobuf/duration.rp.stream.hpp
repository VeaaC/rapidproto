...
RP_FLATTEN ::rapidproto::DecodeStatus Duration::decode(rp_Callbacks&&... rp_callbacks) const {
  ...
  for (;;) {
    ...
    rp_do_1: {
      ...
      static_assert((true && ... && !(::rapidproto::targets<rp_Callbacks, seconds, seconds::Value> && !::rapidproto::specifically_handles<rp_Callbacks, seconds, seconds::Value>)), "a callback for field '::rp::stream::google::protobuf::Duration::seconds' has the wrong value type (expected seconds::Value)");
    ...
    rp_do_2: {
      ...
      static_assert((true && ... && !(::rapidproto::targets<rp_Callbacks, nanos, nanos::Value> && !::rapidproto::specifically_handles<rp_Callbacks, nanos, nanos::Value>)), "a callback for field '::rp::stream::google::protobuf::Duration::nanos' has the wrong value type (expected nanos::Value)");
