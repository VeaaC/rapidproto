...
RP_FLATTEN ::rapidproto::DecodeStatus Pub::decode(rp_Callbacks&&... rp_callbacks) const {
  ...
  for (;;) {
    ...
    rp_do_1: {
      ...
      static_assert((true && ... && !(::rapidproto::targets<rp_Callbacks, w, w::Value> && !::rapidproto::specifically_handles<rp_Callbacks, w, w::Value>)), "a callback for field '::rp::stream::pub::Pub::w' has the wrong value type (expected w::Value)");
